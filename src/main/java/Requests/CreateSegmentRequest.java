...
public class CreateSegmentRequest extends Request<CreateSegmentRequest.Payload>{
    ...
    public CreateSegmentRequest(Header header, @Valid Payload payload) {
        super(header, payload);
    }

    public CreateSegmentRequest(String token, Long pdi_inicial, Long pdi_final, String aviso, Boolean acessivel) {
        super(new Header(token, RequestOperations.CADASTRAR_SEGMENTO),
    ...
    public static class Payload{
        ...
        Long pdi_final;
        String aviso;
        @NotNull(message="O campo acessivel e obrigatorio.")
        Boolean acessivel;
