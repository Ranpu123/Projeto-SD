...
import Model.PDI;
import Requests.UpdatePOIRequest;
import Requests.Request;
import Response.UpdatePOIResponse;
 ...
 * @author vinic
 */
public class UpdatePOIHandler {
    public static Response<?> handle(String jsonRequest)throws ServerResponseException{
        Gson gson = new Gson();
        
        try {
            Request<UpdatePOIRequest.Payload> req = gson.fromJson(jsonRequest, UpdatePOIRequest.class);
            ...
            PDI pdi = controller.atualizarPDI(req.getPayload().getId(), req.getPayload().getNome(), req.getPayload().getPosicao(),
            ...
            UpdatePOIResponse res = new UpdatePOIResponse(pdi.getId(),pdi.getNome(),pdi.getPosicao(),pdi.getAviso(),pdi.getAcessivel());
            return res;
