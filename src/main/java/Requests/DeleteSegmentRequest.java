...
public class DeleteSegmentRequest extends Request<DeleteSegmentRequest.Payload>{
    ...
    public DeleteSegmentRequest(Header header,@Valid Payload payload) {
        super(header, payload);
    }

    public DeleteSegmentRequest(String token, Long pdi_inicial, Long pdi_final) {
        super(new Header(token, RequestOperations.DELETAR_SEGMENTO),
