 ...
 * @author vinic
 */
public class CreateSegmentResponse implements Response<CreateSegmentResponse.Payload>{
    private Payload payload;

    public CreateSegmentResponse(Long pdi_inicial, Long pdi_final, String aviso, Boolean acessivel) {
